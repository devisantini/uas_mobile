...
import 'package:flutter_app/ui/entryForm.dart';
import 'package:flutter_app/models/anggota.dart';
import 'package:flutter_app/helpers/hdatabase.dart';
...
class NoteState extends State<Note> {
  ...
  Future<Anggota> navigateToEntryForm(BuildContext context, Anggota
  anggota) async {
      ...
      itemBuilder: (BuildContext context, int index) {
        return Card(
          ...
          child: ListTile(
            ...
            title: Text(' '+this.anggotaList[index].nama, style:
            textStyle,),
            subtitle: Text(' '+this.anggotaList[index].alamat + ' | ' +
                this.anggotaList[index].nomor),
            ...
            onTap: () async {
              var anggota = await navigateToEntryForm(context,
                  this.anggotaList[index]);
  ...
  void updateListView() {
    ...
    dbFuture.then((database) {
      Future<List<Anggota>> anggotaListFuture =
      dbHelper.getAnggotaList();
